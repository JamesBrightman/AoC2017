...
package adventday5.pkg2rework;

public class AdventDay52Rework {
...
"-889";
        ...
        String[] opts = new String[] { "java.version", "java.vendor",
   ...
   int[] formattedList = new int[splitString.length];
   for (int i = 0; i < splitString.length; i++) {
        formattedList[i] = Integer.parseInt(splitString[i]);}

        int solution = solution(formattedList);
        System.out.println("\n\nSOLUTION: "+solution+"\n\n");
    }    
    ...
    public static int solution(int[] intList){
        int steps=0;
        int i=0;
        while(i < intList.length && i >=0){
            steps++;    //Increment Steps
           int offset = intList[i];
           intList[i]+=(offset >= 3) ? -1 : 1;
           i+=offset;
       //    System.out.println("STEPS : "+steps); // this line makes it take 45 mins           
        }
...
// This took 45 mins to run SOLVED: oh for fucks sake I left a print state in
